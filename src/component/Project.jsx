...
function Project() {
  ...
  <div class="p-6 rounded-xl border-zinc-200 border hover:border-zinc-300 bg-zinc-200/80 hover:bg-zinc-300 text-black shadow-md hover:-translate-y-1 transition-all">
    ...
    <div className='mt-6'>
    <a href="https://github.com/nandana-gopan02/Movie-App" target='_blank' rel='noopener noreferrer' className='mt-6 border md:border border-zinc-900 py-2 px-4 rounded-full cursor-pointer bg-linear-to-r from-zinc-500 via-stone-600 to-zinc-900 text-white hover:opacity-90 hover:-translate-y-0.5 transition-all'>GitHub</a>
    </div>
  </div>
  ...
  <div class="p-6 rounded-xl border-zinc-200 border hover:border-zinc-300 bg-zinc-200/80 hover:bg-zinc-300/80 text-black shadow-md hover:-translate-y-1 transition-all">
    ...
    <div className='mt-6'>
    <a href="https://github.com/nandana-gopan02/BidWise" target='_blank' rel='noopener noreferrer' className='mt-6 border md:border border-zinc-900 py-2 px-4 rounded-full cursor-pointer bg-linear-to-r from-zinc-500 via-stone-600 to-zinc-900 text-white hover:opacity-90 hover:-translate-y-0.5 transition-all'>GitHub</a>
    </div>
  </div>
